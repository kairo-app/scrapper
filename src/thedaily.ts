...
export class TheDailyScraper {
  private readonly RSS_FEED_URL = 'https://feeds.simplecast.com/54nAGcIl';
  private readonly PROVIDER_NAME = 'thedaily';
...
export async function scrapeTheDaily(): Promise<void> {
  const scraper = new TheDailyScraper();
