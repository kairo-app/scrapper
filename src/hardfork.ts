...
export class HardForkScraper {
  private readonly RSS_FEED_URL = 'https://feeds.simplecast.com/l2i9YnTd';
  private readonly PROVIDER_NAME = 'hardfork';
...
export async function scrapeHardFork(): Promise<void> {
  const scraper = new HardForkScraper();
