...
export class SansStormcastScraper {
  private readonly RSS_FEED_URL = 'https://isc.sans.edu/dailypodcast.xml';
  private readonly PROVIDER_NAME = 'sansstormcast';
  ...
  async scrape(): Promise<void> {
    try {
      console.log(`\n🎙️  Starting SANS Internet Stormcenter scraper...`);
...
export async function scrapeSansStormcast(): Promise<void> {
  const scraper = new SansStormcastScraper();
