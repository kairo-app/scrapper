...
export class DeDagScraper {
  private readonly RSS_FEED_URL = 'https://podcast.npo.nl/feed/de-dag.xml';
  private readonly PROVIDER_NAME = 'dedag';
...
export async function scrapeDeDag(): Promise<void> {
  const scraper = new DeDagScraper();
