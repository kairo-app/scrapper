...
export class MaartenVanRossemScraper {
  private readonly RSS_FEED_URL = 'https://anchor.fm/s/21c734c4/podcast/rss';
  private readonly PROVIDER_NAME = 'maartenvanrossem';
  ...
  async scrape(): Promise<void> {
    try {
      console.log(`\n🎙️  Starting Maarten van Rossem en Tom Jessen scraper...`);
...
export async function scrapeMaartenVanRossem(): Promise<void> {
  const scraper = new MaartenVanRossemScraper();
